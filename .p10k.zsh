# Generated by Powerlevel10k configuration wizard on 2025-01-05 at 10:08 JST.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%F{1}%n%F{2}@%F{4}%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%F{1}%n%F{2}@%F{4}%m'
  # Default context format (no privileges, no SSH): user@hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%F{1}%n%F{2}@%F{4}%m'
